...
public class AuthenticationFilter implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse responce, FilterChain chain) throws IOException, ServletException {
		...
		if(uri.endsWith(".css") || uri.endsWith("/") || uri.endsWith("/RegistrationServlet") || uri.endsWith("/.jfif") || uri.endsWith("/.png") || uri.endsWith("/.jpg") || uri.endsWith("/aboutUs.jsp") || uri.endsWith("/ProductDetail.jsp") || uri.endsWith("/ProductServlet") || uri.endsWith("/SearchServlet")){
